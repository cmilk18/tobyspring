...
*/
    ...
    public void add(final User user) throws DuplicateUserIdException, SQLException, ClassNotFoundException {
        try{
    ...
    public User get(String id) throws SQLException, ClassNotFoundException, EmptyResultDataAccessException {
